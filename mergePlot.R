...
indb2=which(bmrg$logP.merge[intb2]>thresh)
 ...
 plot(main=substitute(italic("Trl1")), cex.main=1, bmrg$bp[intb][indb]/1e6, bmrg$logP.merge[intb][indb], ylim=c(0,8.5), lwd=lwd, col=colMrg, xlim=c(129.7,130.8), pch=pch, xlab="Mb", ylab="logP")
...
#	rect(130.27,0.5,130.28,1.1,col=2)
 ...
 plot(main=substitute(italic("Trl2")), cex.main=1,bmrg$bp[intb2][indb2]/1e6, bmrg$logP.merge[intb2][indb2], ylim=c(0,8.5), lwd=lwd, col=colMrg, pch=pch, xlab="Mb", ylab="logP", xlim=c(121.9,max(bmrg$bp[intb2][indb2]/1e6)))
 ...
 plot(main=substitute(bold(italic("Trl3"))), cex.main=1,tnmrg$bp[intn][indn]/1e6, tnmrg$logP.merge[intn][indn], ylim=c(0,8.5), lwd=lwd, col=colMrg, xlim=c(36.1,max(tnmrg$bp[intn][indn]/1e6)), pch=pch, xlab="Mb",ylab="logP")
 ...
 plot(main=substitute(italic("Trl4")), cex.main=1, thmrg$bp[inth][indh]/1e6, thmrg$logP.merge[inth][indh], ylim=c(0,9.5), lwd=lwd, col=colMrg, pch=pch, xlab="Mb", ylab="logP", xlim=c(63.37, max(thmrg$bp[inth][indh]/1e6)))
...
#	 abline(v=c(64.39, 64.41), col="red")
 ...
 plot(main=substitute(italic("Trl5")), cex.main=1,cmrg$bp[intc][indc]/1e6, cmrg$logP.merge[intc][indc], ylim=c(0,8.5),lwd=lwd, col=colMrg, pch=pch, xlab="Mb", ylab="logP", xlim=c(72.42,max(cmrg$bp[intc][indc]/1e6)))
